...
import HeadDashboardView from './HeadDashboardView';
...
import HeadStaffView from '../head/HeadStaffView';
        ...
        <div className="space-y-6">
          ...
          <nav className="space-y-1">
            {navItems.map((item) => {
              ...
              const isActive =
                currentTab === item.id && !selectedComplaintId && !assigningComplaint;
              return (
                <button
                  key={item.id}
        ...
        <main className="p-4 md:p-8 flex-1">
          {selectedComplaintId ? (
            ...
            <>
              ...
              {currentTab === 'reports' && <HeadReportsView />}

              {currentTab === 'staff' && <HeadStaffView />}
